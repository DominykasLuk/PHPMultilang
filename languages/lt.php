...
$lang = array(
	...
	dalimi.</p>
	<p>
	Šis tiltas, pavadintas karaliaus Frydricho Wilhelmo III sūnaus princo Karlo, napoleonmečiu
	gyvenusiu Klaipėdoje, vardu. Sutikimą vardui davė pats princas Karlas 1826 m. liepos 2 d. raštu.
	</p>
	<p>
	Karlo tilto atidaroma anga buvo 11,6 m pločio. 1877–1878 m. jis perstatytas, o 1902 m., gavus 127
	000 markių subsidiją, atnaujintas. Tilto anga laivams praplaukti po tiltu praplatinta iki 17,5 m
	pločio. Nutiesus tramvajaus liniją, 1904 m. medinis Karlo tiltas pakeistas metaliniu. Jį varstė
	elektros variklis. Anga laivams praplaukti buvo 20 metrų pločio. Tilto turėklai buvo metaliniai,
	o jų viršų puošė jugendui būdingi elementai.
	</p>
	<p>
	Ant Karlo tilto veikė nedidelės krautuvėlės, kurios vėliau uždraustos.
	</p>
	<p>
	Tiltas buvo rekonstruotas apie 1974-1976 m.
	</p>
	<p>
	Kapitalinis Pilies tilto remontas vyko 2014 m. Darbininkams teko demontuoti tilto konstrukcijas
				ir dalį jų atnaujinimui gabenti į gamyklą. Jos buvo remontuojamos, perdažomos ir vėl grąžintos
				sumontavimui. Kai kurios konstrukcijos atnaujintos vietoje. Už 12,9 mln. litų suremontuotos
				metalinės ir gelžbetoninės laikančiosios tilto konstrukcijos, atlikti hidraulinės tilto pakėlimo
				sistemos remonto darbai, pakeistas tilto pakėlimo mechanizmas, sistema automatizuota, atlikti
				valdymo, vidaus ir išorės apdailos darbai, naujai įrengta pakeliamos tilto dalies ir prietilčių
				važiuojamosios dalies danga. Naujai įrengti ir suremontuoti pėsčiųjų ir dviračių takai, tiltas
				pritaikytas žmonėms su negalia, įrengti 4 pakeliami kelio užtvarai, kurie užtvers automobilių
				eismą tilto pakėlimo metu. Dėl naujai sumontuoto pakėlimo mechanizmo ši procedūra užtruks vos
				kelias minutes. Tiltą apšvies saulės ir vėjo gaminamą elektrą naudojantys šviestuvai.
	</p>',
	...
	<p>
	1971 m. liepos 20 d., pirmosios Žvejų šventės metu, skulptūra atidengta visuomenei. „Žvejo“ paminklas pastatytas siekiant įtikinti visuomenę apie neva tvirtas uostamiesčio žvejybos tradicijas.
...
<p>Savivaldybė: Klaipeda</p>',
	...
	<p>Pirminiame modelyje moteris laikė sutraukytą grandinę, simbolizuojančią vokiečių tautos išsilaisvinimą. Tačiau grandinė buvo pakeista durklu. Borussia, panaši į senovės graikų deivę Atėnę, buvo užkelta ant cilindrinio su kaneliūromis granitinio pjedestalo, o šis su skulptūra – ant laiptuoto granitinio pamato. Cilindrinį pjedestalą puošė ovalūs bareljefai. Viename jų – Frydricho Vilhelmo III ir jo žmonos Luizės portretai, kitame – metai: „1807–1907“. Ovalus jungė bronzinės girliandos. 1924 m. dešinėje paminklo pusėje stovėjo hermos: granitiniai kvadratinio skerspjūvio pjedestalai, o ant jų – Vokietijos karvedžių ir valstybės veikėjų biustai (Friedrich Ferdinand Alexander, Karl August Fürst, Theodor von Schön, Gerhard von Scharnhorst, August Graf Neidhardt, Friedrich Leopold von Schrötter, Heinrich Friedrich Karl vom und zum Stein, Ludwig Yorck).</p>
...
',
	...
	Šiame pastate buvo įsikūrusios įstaigos: Klaipėdos krašto direktorija, Kelionių agentūra, bankas. Klaipėdos krašto direktorija – Klaipėdos krašto administracinis organas, veikęs 1920–1939 m. Apie 1923-1925 m. direktorijos vertimų biure dirbo Klaipėdos krašto rašytoja Ieva Simonaitytė. Tuo metu direktorijos pirmininkas buvo Viktoras Gailius.
	Pastatas išlikęs. Dabar (2017 m.) jame veikia kavinės.</p>
	<p>Objektas pažymėtas jūrinio paveldo ženklu. Šiuo ženklu ženklinami su jūriniu paveldu susiję objektai – pastatai ir buvusių pastatų vietos, krantinės, takai, laivai ir kita. Taip siekiama pabrėžti Klaipėdos kaip jūrinio miesto išskirtinumą. Kartu išryškinamas ir Lietuvos kaip jūrinės valstybės veidas.
	</p>
',
...
',
    ...
    Pakeitus laivo paskirtį, 1971 m. „Meridianas“ atplukdytas į Dangės upę, jame atidarytas restoranas. Anuomet tai buvo visų klaipėdiškių mėgiamas restoranas.
    Vėliau „Meridianas“ dar kartą remontuotas, atnaujintas jo interjeras, medinis korpusas “įvilktas” į skardo šarvą. Laivas-restoranas, stovėdamas prie Danės krantinės tapo neatskiriama uostamiesčio dalimi.</p>
    <p>Kol „Meridiano“ savininkai vykdė komercinę veiklą, laivas ėmė keistai svirti vienon pusėn, laivagalis leistis vis žemyn. Laivo būkle susirūpino miestelėnai. Į nenormalią laivo būklę dėmesį atkreipė ir kažkada juo plaukioję jūrininkai.</p>
    <p>2000 m. pradžioje buvo sukurta speciali komisija, kuri turėjo nustatyti laivo tolimesnį likimą. Komisija nusprendė uždrausti laivo eksploataciją bei jo švartavimąsi.</p>
    <p>2000 m. spalio mėnesį apylinkės teismo posėdyje buvo sprendžiamas klausimas dėl laivo nutempimo nuo savivaldybės krantinių.</p>
    <p>2001 m. laivą už simbolinį vieną litą iš savivaldybės nupirko Vyriausybės atstovo Klaipėdos apskrityje juristas patarėjas Artūras Žičkus, kuris ėmėsi iniciatyvos prikelti „Meridianą“ naujam gyvenimui.</p>
    <p>2001 m. balandžio 12 d. naktį laivas buvo nubuksyruotas į AB „Klaipėdos laivų remontas“ doką.
    „Meridiano“ remontui buvo įsteigtas specialus paramos fondas į kurį pinigus pervedė ne tik miestelėnai, bet ir didžiosios miesto kompanijos. Pagrindinis rėmėjas – alaus darykla „Švyturys”.</p>
    <p>2002 m. pavasarį laivas grįžo atsinaujinęs į savo senąją vietą ir nudžiugino savo atnaujintais baltais bortais miesto gyventojus bei svečius per Klaipėdos miesto 750 metų jubiliejų.</p>
    <p>2012 m. rudenį pasikeitė „Meridiano“ savininkai, šiuo metu burlaivis priklauso Aidui Kaveckui ir Aloyzui Kuzmarskiui, kurių iniciatyva buvo sutvarkytas ir gražintas į savo nuolatinio stovėjimo vietą 2013 m. lapkričio 9 dieną.</p>
    <p>Po rekonstrukcijos įrengtas restoranas, pažintinė ekspozicija apie laivą, atkurtos vairinės detalės. 2014 m. liepos 19 d. įvyko laivo atidarymo ceremonija. Lauko ekspozicijoje galima apžiūrėti: originalų „Meridiano“ sraigtą, medinių konstrukcijų (špangautų), bortų dalis, autentiško medinio fokstiebio fragmentą, tašytus balasto akmenis, alsuoklius ir žibintus.</p>
',
...
',
    ...
    'jono-kalnelis_paragrafas' => '
		...
		<p>XVIII a. antroje pusėje miesto įtvirtinimai prarado svarbą, vartus pradėjo griauti plytoms, pylimus išnuomoti, griovius užpilti žemėmis, todėl XX a. išliko tik nedideli sudėtingos įtvirtinimų sistemos fragmentai.</p>
		<p>Ryškiausiai įtvirtinimų vaizdas atsiskleidžia nuo Turgaus gatvės gale esančių bastionų (dabar ši teritorija vadinama Jono kalneliu) istoriniuose planuose vadinamų Geldern ir Purmark vardais. Priešais juos matosi apsauginio griovio vanduo ir vienintelis išlikęs ravelinas. 1994–1997 m. šios gynybinių įtvirtinimų liekanos buvo restauruotos (projekto autorius V. Šliogeris).</p>
		<p>Manoma, kad pavadinimą ši vieta gavo iš čia stovėjusios ir pokaryje sunaikintos Šventojo Jono evangelikų liuteronų bažnyčios (pastatytos 1706 metais), vieno iš ryškių prieškario Klaipėdos architektūros akcentų.</p>
		<p>Jono kalnelyje kasmet vyksta Joninių šventė, pritraukianti miesto gyventojus ir svečius. Pavasarį čia švenčiamos Užgavėnės: groja liaudiška muzika, šokami lietuviški tautiniai šokiai, vasarą, Jūros šventės metu, čia vyksta įvairūs renginiai, koncertai, diskotekos.</p>
    ...
    'jono-kalnelis_paragrafas' => '
		...
		<p>Po Antrojo pasaulinio karo superfosfatą (30-50 tūkst. t per metus) gamino Klaipėdoje 1947-1956 m. veikęs superfosfato fabrikas nauju pavadinimu „Artojas“ (buv. „Union“). Vėliau, po fabriko Artojų gatvėje rekonstrukcijos čia iki 1996 metų veikė cheminių elementų fabrikas "Sirijus". Šiandien UNION fabriko pastatai priklauso įvairiems savininkams, dalis pastatų priklauso UAB „Laivitė“, kuri gamina lietuviškus katerius. Įmonės savininkai planuoja įrengti prieigą prie upės ir gervę laivelių nuleidimui.</p>
		<p>Objektas pažymėtas jūrinio paveldo ženklu. Šiuo ženklu ženklinami su jūriniu paveldu susiję objektai – pastatai ir buvusių pastatų vietos, krantinės, takai, laivai ir kita. Taip siekiama pabrėžti Klaipėdos kaip jūrinio miesto išskirtinumą. Kartu išryškinamas ir Lietuvos kaip jūrinės valstybės veidas.</p>
    ...
    'upes-zuvys_paragrafas' => '
		...
		<p><strong>Ešerys – Perca fluviatilis</strong></p>
		<p><strong>Paprastoji aukšlė – Alburnus alburnus</strong></p>
		<p><strong>Raudė – Scardinius erythrophtalmus</strong></p>
        <p>Meknė – Leuciscus idus</p>
        <p>Šapalas – Leuciscus cephalus</p>
        <p>Salatis – Aspius aspius</p>
        <p>Sidabrinis karosas – C. auratus gibelio</p>
        <p>Lynas – Tinca tinca</p>
        <p>Plakis – Blicca bjoerkna</p>
        <p>Saulažuvė – Leucaspius delineatus</p>
        <p>Pūgžlys – Gymnocephalus cernua</p>
        <p>Trispyglė dyglė – Gasterosteus aculeatus</p>
        <p>Upinė nėgė – Lampetra fluviatilis</p>
        <p>Lašiša - Salmo salar</p>
	',
    ...
    'pilkasis-garnys_paragrafas' => '
		...
		Didžiųjų pilkųjų garnių ūgis 132 cm, sparnų ilgis 213 cm ir svoris 2,5 kg. Jie turi ilgą geltoną snapą. Suaugę garniai turi melsvai pilkus sparnus ir baltą galvą su juodu vainikėliu ir ilga juoda plunksna.</p>
	',
    ...
    'danges-uostas_paragrafas' => '
		...
		<p>Po Antrojo pasaulinio karo Dangės uosto aplinka gerokai pasikeitė. Pirmaisiais pokario metais būta sumanymo išgriauti visus krantinėse stovėjusius pramoninės ir sandėliavimo paskirties pastatus ir abipus upės įrengti žaliąją zoną. Įgyvendinant šį sumanymą, buvo demontuoti per karą apgriauti biržos, muitinės, linų svarstyklių pastatai, išgriauti sandėliai Šiaurės rage, o krantinė apsodinta medžiais bei vietomis užstatyta tipinės statybos gyvenamaisiais namais. Senąją uosto infrastruktūrą mena išlikę nenugriauti raudonų plytų sandėliai, buvęs Roberto Meyhoeferio laivininkystės bendrovės pastatas bei keli knechtai laivams prišvartuoti.</p>
		<p>1969 m. Dangės krantinėje buvo prišvartuotas burlaivis „Meridianas". 1948 m. jį pastatė Turku miesto (Suomija) laivų statykla ir kartu su kitais 48 tokio tipo burlaiviais kaip karo reparaciją perdavė SSRS. Iki 1967 m. Klaipėdos jūreivystės mokyklos studentai atlikdavo jame jūrinę praktiką. 1971 m. jame įkurdintas restoranas, kuris aštuntajame ir devintajame dešimtmečiais buvo laikomas vienu geriausių mieste.</p>
		',
